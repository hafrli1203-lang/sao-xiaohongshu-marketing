...
export default function ContentExamples() {
  return (
    <section id="content-examples" className="py-32 bg-gray-900 text-white relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-400 font-medium">실제 유저 반응을 이끌어내는 트렌디한 감성의 콘텐츠입니다.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8">
          {contentExamplesData.map((example) => (
            <figure 
              key={example.id} 
              className="relative rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] bg-black/50 mx-auto w-full max-w-5xl group"
            >
